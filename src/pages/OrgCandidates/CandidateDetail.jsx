...
function RadarChart({ scoreIntel, size = 500 }) {
  ...
  return (
    ...
    >
      <Box
        sx={{ display: "flex", gap: "20px", mb: "8px", alignSelf: "flex-end" }}
      >
        {[
      ...
      <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
        ...
        {scoreIntel.map((d, i) => {
          ...
          const label =
            d.skill.length > 13 ? d.skill.slice(0, 12) + "…" : d.skill;
          return (
            <text
              key={i}
              x={lx}
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: "8px" }}>
          {Object.entries(skillNotes).map(([key, note]) => (
            <Box key={key} sx={{ display: "flex", gap: "6px" }}>
              ...
              {/* note = value */}
              <Typography sx={{ fontSize: T.valueSize }} lineHeight={1.65}>
                {note}
              </Typography>
            </Box>
          ))}
      ...
      {skillInfo.skillintel_score != null && (
        ...
        >
          ...
          <Typography fontSize={T.labelSize} fontWeight={700} color={C.accent}>
            ...
            <Box
              component="span"
              sx={{ fontSize: T.valueSize, fontWeight: 600 }}
            >
      ...
      >
        ...
        >
          <Box sx={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <Box>
              ...
              {/* Sub-label = value */}
              <Typography fontSize={T.valueSize} color={C.textSecondary}>
                {scoreIntel.length} skill{scoreIntel.length !== 1 ? "s" : ""}{" "}
                evaluated
              </Typography>
            </Box>
          </Box>
        ...
        <DialogContent sx={{ p: 0, maxHeight: 420, overflowY: "auto" }}>
          {scoreIntel.map((s, i) => {
            ...
            const barColor =
              pct >= 90 ? "#22C55E" : pct >= 70 ? C.accent : "#EF4444";
        ...
        >
          {[
            ...
            >
              ...
              <Typography fontSize={T.labelSize} fontWeight={800} color={color}>
                {count}
              </Typography>
        ...
        >
          ...
          >
            <Box>
              {/* Job title = label */}
              <Typography
                sx={{ fontSize: T.labelSize, fontWeight: 600 }}
                color={C.textPrimary}
              >
                {emp.job_title}
              </Typography>
          ...
          {/* Dates = value */}
          <Box
            sx={{ display: "flex", gap: "8px", mb: "10px", flexWrap: "wrap" }}
          >
      ...
      {education.map((edu, i) => (
        ...
        >
          ...
          >
            ...
            <Typography sx={{ fontSize: T.labelSize }} color={C.teal}>
              {edu.end_year ?? "—"}
            </Typography>
          </Box>
          <Box>
            ...
            {/* University = value */}
            <Typography
              sx={{ fontSize: T.valueSize, color: C.textSecondary, mt: "2px" }}
            >
              {edu.university}
            </Typography>
            {edu.specialization && (
              <Typography
                sx={{ fontSize: T.valueSize, color: "#9CA3AF", mt: "2px" }}
              >
                {edu.specialization}
              </Typography>
            )}
                ...
                >
                  <Box
                    sx={{
                      ...
                      justifyContent: "center",
                      boxShadow:
                        state !== "pending" ? `0 0 0 4px ${sc.bg}33` : "none",
                      mt: "2px",
                      flexShrink: 0,
                    }}
                  >
                ...
                <Box sx={{ pb: isLast ? 0 : "12px", width: "100%", pt: "4px" }}>
                  ...
                  {firstEntry.triggered_by && (
                    <Box sx={{ display: "flex", alignItems: "center" }}>
                      ...
                      <Typography
                        sx={{ fontSize: T.valueSize, fontWeight: 500, ml: 1 }}
                        color={C.textSecondary}
                      >
                        {firstEntry.triggered_by}
                      </Typography>
                          ...
                          >
                            <Box
                              sx={{
                                ...
                                mt: "2px",
                                flexShrink: 0,
                                backgroundColor: subSc.bg,
                                border: `2px solid ${subSc.border}`,
                                display: "flex",
                                alignItems: "center",
                                justifyContent: "center",
                              }}
      ...
      <Grid size={{ xs: 12, md: 6 }}>
        ...
        >
          {[
            ...
            {
              label: "Current stage",
              value: candidate.current_stage?.replace(/_/g, " "),
            },
            ...
            >
              ...
              <Typography fontSize={T.labelSize} color={C.textSecondary}>
                {label}
              </Typography>
        ...
        {candidate.upcoming_interview && (
          ...
          >
            ...
            >
              ...
              <Typography fontSize={T.labelSize} color={C.accent}>
                →
              </Typography>
            </Box>
          </Box>
...
export default function CandidateDetail() {
  ...
  useEffect(() => {
    if (candidate?.full_name) {
      dispatch(
        setDynamicLabels({
          candidateId: candidate.full_name,
        }),
      );
    }
  }, [candidate]);
  ...
  return (
    <Box sx={{ p: 1, backgroundColor: "#fff" }}>
      ...
      {/* ID line = value size */}
      <Typography
        sx={{ fontSize: T.valueSize, color: "#9CA3AF", ml: 3 }}
        mb="16px"
      >
