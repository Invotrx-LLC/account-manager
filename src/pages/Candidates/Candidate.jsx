    ...
    <Box sx={{ p: 1 }}>
      ...
      >
            ...
            {[
              ...
              >
                ...
                {value === true && activeCount > 0 && (
                  <Box
                    component="span"
                    sx={{ ml: "4px", fontSize: 10, opacity: 0.8 }}
                  >
                    ({activeCount})
                  </Box>
                )}
        ...
        >
          ...
          {/* Applied chips */}
          <Box
            sx={{ display: "flex", gap: "6px", flexWrap: "wrap", ml: "4px" }}
          >
            {domain && (
              <Chip
                ...
                sx={{
                  ...
                  backgroundColor: C.accentSoft,
                  color: C.accent,
                  "& .MuiChip-deleteIcon": { fontSize: 14, color: C.accent },
                }}
              />
            )}
            {func && (
        ...
        <>
          ...
          >
            <Typography fontSize={12} color={C.textSecondary}>
              ...
              candidates
              {activeOnly !== null &&
                allCandidates.length !== displayed.length && (
