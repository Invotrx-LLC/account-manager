...
//   console.log("creatorId", editData?.creatorId);
//   console.log("approverId", editData?.approverId);
//   console.log("taTeam", editData?.taTeam);
//   console.log("approvers", approvers);
//   console.log("orgId", orgId);
//   console.log("approvers length", approvers.length);
...
//   // ── Effects ──
//   useEffect(() => {
//     // STOP auto-selection while editing
//     if (isEditMode) return;

//     if (selectedFunction === "biostatistics" && subFunctionsData.length) {
//       const opt = subFunctionsData.find(
...
//       }
//     }
//   }, [selectedFunction, subFunctionsData, isEditMode]);
...
//       s => s.lable === selectedSubFunction
//     );

//     if (match) {
//       setSubFunctionKey(match.sub_function);
//     }
//   }, [subFunctionsData, selectedSubFunction, isEditMode]);
//   useEffect(() => {
//     if (!isEditMode || !editData) return;

//     setSelectedDomain(editData.selectedDomain);
//     setSelectedFunction(editData.selectedFunction);
//     setSelectedSubFunction(editData.selectedSubFunction);
//     setSubFunctionKey(editData.subFunctionKey);
//     setSkillMode(editData.skillMode);
...
//     setPositionsCount(editData.positionsCount);

//     setPriority(editData.priority);
//     setJobType(editData.jobType);
//     setWorkMode(editData.workMode);

//     setSalaryUnit(editData.salaryUnit);
//     setSalary(editData.salary);

//     setClosingDate(editData.closingDate);

//     if (approvers.length > 0) {
//       const selectedCreator = approvers.find(
//         (a) => a.employee_id === editData.creatorId
//       );

//       const selectedApprover = approvers.find(
//         (a) => a.employee_id === editData.approverId
//       );
...
//     setTaTeam(editData.taTeam || []);

//     setInstructions(editData.instructions);

//     setNormalSkills(editData.normalSkills || []);
//     setPrimarySkills(editData.primarySkills || []);
//     setMandatorySkills(editData.mandatorySkills || []);
//     setSecondarySkills(editData.secondarySkills || []);

//     setCpMandatory(editData.cpMandatory || []);
//     setCpSecondary(editData.cpSecondary || []);

//     setEdcTools(editData.edcTools || []);
//     setTherapeutic(editData.therapeutic || []);

//     setDomainSkills(editData.domainSkills || []);

//     // IMPORTANT: remove edit state after loading once
